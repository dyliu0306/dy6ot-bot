...
fragment RecordFragment on UserRecord{{
  ...
  # 123
    if message.content == '你好':
        await message.channel.send("歡迎遊玩解謎遊戲\n以下將說明遊戲規則：\n\n• 傳送訊息後若無反應即回答有誤。\n• 有些題目有提示，以數字表示提示數量。提示有漸進順序，以英文字母排列，字母越後面，提示就更容易解題。\n• 若想查看提示，請回答「<題號><英文字母>」\n• 查看提示範例：\n——————————\n題目50：\n題目內容。\n提示數量：2\n——————————\n輸入「50a」將回覆題目50的第一個提示\n輸入「50b」將回覆題目50的第二個提示\n輸入「50c」將不回覆任何內容\n\n• 無法成功解題可輸入「pass<題號>」，將說明謎底並進入下一題\n\n那麼，讓我們開始遊戲，請輸入「開始遊玩」")
    if message.content == '提示':
        await message.channel.send("**若想查看提示，請輸入「<題號><英文字母>」**\n")

    if message.content == '開始遊玩':
        await message.channel.send("**題目1**\n請查看圖片。\n\n提示數量：1\n謎底：一個數字(**以中文回答**)")
        await message.channel.send("https://media.discordapp.net/attachments/951022756529602641/1093702058848297011/1680829286485.jpg")
    if message.content == '1a':
        await message.channel.send("提示1a: 將選中的圖片連起來吧！")
    if message.content == '4':
        await message.channel.send("你是不是沒看清楚題目要求呢？")
    if message.content == 'pass1':
        await message.channel.send("圖片中1、3、4、5（校狗）、6、9格都是大直高中校園場景，連線為「四」")
        await asyncio.sleep(7)
        await message.channel.send("那麼，前往下一題。")
        await asyncio.sleep(3)
        await message.channel.send("**題目2**\n請查看圖片。\n\n提示數量：1\n謎底：四個中文字")
        await message.channel.send("https://cdn.discordapp.com/attachments/951022756529602641/1093702058617622538/1680829286475.jpg")

    if message.content == '四':
        await message.channel.send("答對了！前往下一題。")
        await asyncio.sleep(3)
        await message.channel.send("**題目2**\n請查看圖片。\n\n提示數量：1\n謎底：四個中文字")
        await message.channel.send("https://cdn.discordapp.com/attachments/951022756529602641/1093702058617622538/1680829286475.jpg")
    if message.content == '三':
        await message.channel.send("誰准你暴力破解的:rage:\n誰准你暴力破解的:rage:\n誰准你暴力破解的:rage:\n誰准你暴力破解的:rage:\n")

    if message.content == 'pass2':
        await message.channel.send("這個亂碼是注音符號忘記切了，答案是大直高中")
        await asyncio.sleep(7)
        await message.channel.send("那麼，前往下一題。")
        await asyncio.sleep(3)
        await message.channel.send(">>> 一輩子一次的高中畢旅\n延期換行程然後停辦\n差那一點點的時間\n時間不會倒流")
        await message.channel.send("--------------\n提示數量：1\n謎底：四個字，日本茶道用語")
        await asyncio.sleep(15)
        await message.channel.send("-----\n不用擔心，是漢字:D")
        await asyncio.sleep(30)
        await message.channel.send("-----\n好像有個關鍵詞需要自己動手查？")
    if message.content == '2a':
        await message.channel.send("提示2a: 這串字有什麼意思嗎？每個注音符號與聲調都被替換成另一個字(含空格)")

    if message.content == '大直高中':
        await message.channel.send("答對了！前往下一題。")
        await asyncio.sleep(3)
        await message.channel.send("**題目3**\n ")
        await message.channel.send(">>> 一輩子一次的高中畢旅\n延期換行程然後停辦\n差那一點點的時間\n時間不會倒流")
        await message.channel.send("--------------\n提示數量：1\n謎底：四個字，日本茶道用語")
        await asyncio.sleep(15)
        await message.channel.send("-----\n不用擔心，是漢字:D")
        await asyncio.sleep(30)
        await message.channel.send("-----\n好像有個關鍵詞需要自己動手查？")
    if message.content == '3a':
        await message.channel.send("提示3a: 這串句子是不是藏著什麼詞？四句又有四個字（觀察句數與字數的關聯吧！）")
    if message.content == 'pass3':
        await message.channel.send("答案是一期一會 (日本用語，原指茶道中的待客精神，後推廣至珍惜一生一次的機會)")
        await asyncio.sleep(7)
        await message.channel.send("那麼，前往下一題。")
        await asyncio.sleep(3)
        await message.channel.send("**題目4**")
        tmpmsg = await message.channel.send("請前往以下連結\nhttp://user173033.psee.io/4gzauf")
    ...
    if message.content == '一期一會':
        ...
        await message.channel.send("```.... /. / .- / .-.. / - / .... / -.-. / . / -. / - / . / .-.```")
        await message.channel.send("-------------\n提示數量：1\n謎底：學校處室 (**請將答案轉成四個中文**)")
    if message.content == '4a':
        await message.channel.send("https://telecom.nstm.gov.tw/ckfinder/userfiles/Images/12112(1).jpg")
    if message.content == 'pass4':
        await message.channel.send("這是摩斯密碼,破譯後得出文字healthcenter,健康中心")
        await asyncio.sleep(7)
        await message.channel.send("那麼，前往下一題。")
        await asyncio.sleep(3)
        await message.channel.send("**題目5**: 英文課")
        await message.channel.send("你想抄作業，但同學為了搞你而把內容加密")
        await message.channel.send(">>> Fly me to the moon,and let me play among the stars. \nTell me what spring islike on a Jupiter or mars.\nIn other words hold my hand,and in other words darling kiss me…")
        await message.channel.send("-------------\n提示數量：0\n謎底：英文人名(```_ _ _ _ _     _ _ _ _ _ _ _```)")

    if message.content == "健保中心":
        await message.channel.send("答對了！前往下一題。")
        await asyncio.sleep(3)
        await message.channel.send("**題目5**: 英文課")
        await message.channel.send("你想抄作業，但同學為了搞你而把內容加密")
        ...
        await message.channel.send("似乎查一下就能破解了")

    if message.content == '健康中心':
        await message.channel.send("答對了！前往下一題。")
        await asyncio.sleep(3)
        await message.channel.send("**題目5**: 英文課")
        await message.channel.send("你想抄作業，但同學為了搞你而把內容加密")
    ...
    if message.content == 'pass5':
        await message.channel.send("此題不可跳過")
    if message.content == 'Frank Sinatra':
        await message.channel.send("恭喜你通過了")
    if message.content == 'frank sinatra':
        await message.channel.send("恭喜你通過了")
    if message.content == 'Frank sinatra':
        await message.channel.send("恭喜你通過了")
